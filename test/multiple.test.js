...
describe(`Testing Muter concurrency:`, function () {
  ...
  it(`console.log and console.error don't interfere`,
    unmutedCallback(function () {
      ...
      expect(this.log.getLogs()).to.equal(
        'Test console.log, should be muted\n');
...
`);
  ...
  it(`console.warn and console.error don't interfere`,
    unmutedCallback(function () {
      this.warn.mute();
...
`);
  ...
  it(`console.log and console.info don't interfere`,
    unmutedCallback(function () {
      this.log.mute();
