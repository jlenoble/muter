...
var AdvancedMuter = function () {
  function AdvancedMuter() {
    ...
    var properties = (_properties = {}, _defineProperty(_properties, _muters, { value: new Map() }), _defineProperty(_properties, _options, { value: new Map() }), _defineProperty(_properties, _key, {
      value: function value(logger, method) {
    ...
    }), _defineProperty(_properties, _loggerKeys, { value: new Map() }), _defineProperty(_properties, _loggerKeyCounter, { value: 0, writable: true }), _defineProperty(_properties, _fullLogs, { value: [] }), _defineProperty(_properties, _individualLogs, { value: new Map() }), _defineProperty(_properties, _listener, {
      value: function value(args, muter) {
