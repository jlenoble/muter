...
var SimpleMuter = function (_EventEmitter) {
  ...
  _createClass(SimpleMuter, [{
    ...
    value: function mute() {
      ...
      _sinon2.default.stub(this.logger, this.method).callsFake(function () {
    ...
    value: function getLogs() {
      ...
      if (this.isActivated) {
        ...
        var _endString = options.endString;
        ...
        if (!_endString) {
          _endString = this.endString;
        }

        var calls = this.logger[this.method].getCalls();

        calls = calls.map(function (call) {
          return format.apply(undefined, _toConsumableArray(call.args)) + _endString;
        });
